      ...
      <div class="optimization-status" v-if="chargingOptimization">
        ...
        <div v-if="chargingOptimization.enabled && chargingOptimization.adjusted_params" class="params-info">
          <div class="param-item">
            ...
            <span class="param-value">{{ (chargingOptimization.adjusted_params.cc_current * capacity).toFixed(2) }} A</span>
          </div>
          <div class="param-item">
            <span class="param-label">充电电压:</span>
            <span class="param-value">{{ chargingOptimization.adjusted_params.cv_voltage.toFixed(2) }} V</span>
          </div>
          <div class="param-item">
          ...
          <div class="param-item">
            ...
            <span class="param-value">{{ chargingOptimization.adjusted_params.max_soc }}%</span>
          </div>
        </div>
      </div>
