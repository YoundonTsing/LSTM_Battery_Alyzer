...
BATTERY_CONFIG = {
    ...
    # 串联电池架构参数 (400V平台)
    "cell_count_series": 100,        # 串联节数 (375V ÷ 3.75V = 100节)
    "cell_nominal_voltage": 3.75,    # 单体标称电压 (V)
    "cell_max_voltage": 4.0,         # 单体最大电压 (V) 
    "cell_min_voltage": 2.9,         # 单体最小电压 (V)
    "cell_cc_to_cv_voltage": 3.95,   # 单体CC-CV切换电压 (V)
}
